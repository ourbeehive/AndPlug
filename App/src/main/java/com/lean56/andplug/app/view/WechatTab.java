 ...
 * see {https://coding.net/u/coding/p/Coding-Android/git/blob/master/app/src/main/java/net/coding/program/third/WechatTab.java}
 *
...
public class WechatTab extends HorizontalScrollView {
    ...
    private int tabPadding = 3; // padding when tab is textview
    ...
    private int tabBackgroundResId = R.drawable.bg_wechat_tab;
