...
/**
 * PhotoPickDetailActivity
 *
 * @author Charles
 */
public class PhotoPickDetailActivity extends BaseActivity {

    private final static String TAG = PhotoPickDetailActivity.class.getSimpleName();
    ...
    protected int getContentView() {
        return R.layout.photo_pick_detail;
    }
    ...
    private void updateDisplay(int pos) {
        ...
        setTitle(String.format(actionbarTitle, pos + 1, getImageCount()));
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.photo_pick_detail, menu);
